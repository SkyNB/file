...
public class EncryptUtil {
	...
	public static String CryptKey = "KoMGFGNtOpF4xNs5eU89AQ==";

	/**
	 * <li>方法名称:encrypt</li>
	 * <li>加密方法
	 * 
	 * @param Str 需要加密的消息字符串
	 * @return 加密后的字符串
	 */
	public static String encrypt(String str) {
		...
		byte[] key = new byte[8];
		byte[] iv = new byte[8];
		getKeyIV(EncryptUtil.CryptKey, key, iv);
	 ...
	 * </li>
	 * 
	 * @param str 需要解密的消息字符串
	 * @return 解密后的字符串
	 * @throws Exception
	 */
	public static String decrypt(String str) throws Exception {
		// base64解码
		byte[] encBuf = Base64.decode(str);
		// 取密钥和偏转向量
		byte[] key = new byte[8];
		byte[] iv = new byte[8];
		getKeyIV(EncryptUtil.CryptKey, key, iv);
	...
	public static void main(String[] args) {
		...
		String decode =encrypt("OrderVO|{\"adress\":\"werewrewrew\",\"amountCredit\":\"werewrewrew\",\"billAmount\":\"werewrewrew\",\"borrowCycle\":\"werewrewrew\",\"cardId\":\"werewrewrew\",\"commitmentTime\":1512551166283,\"contactResult\":\"werewrewrew\",\"cutomerName\":\"werewrewrew\",\"easiness\":\"werewrewrew\",\"label\":\"\",\"lastTime\":null,\"loanNumber\":\"\",\"loanTime\":null,\"orderStatus\":\"\",\"phoneModel\":\"\",\"registerPhone\":\"\",\"registerTime\":null,\"remarks\":\"\",\"repayTime\":null,\"taskTime\":null}");
		System.out.println(decode);
		String encode;
		try {
			encode = decrypt(decode);
