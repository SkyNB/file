package com.tasfe.sis.base.utils.json;
...
public class JsonUtil {
    ...
    public static String writeEntity2Json(Object object) throws IOException {
        if (null == object) {
            logger.error("class:JsonUtil,method:writeEntity2Json,param:object == null");
            return null;
        }
        logger.debug("class:JsonUtil,method:writeEntity2Json,param:object=" + object);
    ...
    public static String[] writeListObject2ArrayJson(List list) throws IOException {
        if (null == list || list.size() == 0) {
            logger.error("class:JsonUtil,method:writeListObject2ArrayJson,param==null");
            return null;
        }
    ...
    public static Object readJson2Entity(String json, Class c) {
        logger.debug("class:JsonUtil,method:readJson2Entity,param:json=" + json);
        try {
            return objectMapper.readValue(json, c);
        } catch (JsonParseException e) {
            logger.error("class:JsonUtil,method:readJson2Entity", e);
            return null;
        } catch (JsonMappingException e) {
            logger.error("class:JsonUtil,method:readJson2Entity", e);
            return null;
    ...
    public static <T> T String2Object(String json, Class<?> classObj, Class<?>... valueType) {
        T result = null;
        try {
            result = objectMapper.readValue(json, getCollectionType(classObj, valueType));
        } catch (Exception e) {
            logger.error("json转换异常", e);
        }
        return result;
