...
public class MybatisRepositoryQuery implements RepositoryQuery {
    ...
    public MybatisRepositoryQuery(SqlSessionTemplate sqlSessionTemplate, Method method, RepositoryMetadata repositoryMetadata, ProjectionFactory projectionFactory) {
