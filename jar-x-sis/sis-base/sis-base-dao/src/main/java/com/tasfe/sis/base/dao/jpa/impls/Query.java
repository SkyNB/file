package com.tasfe.sis.base.dao.jpa.impls;
 ...
 * Query,封装JPA CriteriaBuilder查询条件
 */
...
public class Query implements Serializable {
     ...
     * @param object    参数值
     */
    private void setParameter(final ParameterExpression parameter, final Object object) {
        if (parameters == null) {
     ...
     */
    private ParameterExpression makeParameter(final Object value) {
     ...
     * 增关联查询
     */
    public void addLinkQuery(final String propertyName, Query query) {
     ...
     */
    private void addSubQuery(final String propertyName, Query query) {
     ...
     * @return 返回query实例
     */
    public Query addOrder(final String propertyName, final String order) {
        if (this.orders == null) {
            this.orders = new ArrayList();
        }
     ...
     * @return 返回query实例
     */
    public Query setOrder(final String propertyName, final String order) {
        this.orders = null;
     ...
     * @return query实例
     */
    public Query selectAvg(final String propertyName) {
     ...
     * @return query实例
     */
    public Query selectSum(final String propertyName) {
     ...
     * @return query实例
     */
    public Query selectSumAsLong(final String propertyName) {
     ...
     * @return query实例
     */
    public Query selectSumAsDouble(final String propertyName) {
     ...
     * @return query实例
     */
    public Query selectMax(final String propertyName) {
     ...
     * @return query实例
     */
    public Query selectMin(final String propertyName) {
     ...
     * @return query实例
     */
    public Query whereEqual(final String propertyName, final ParameterExpression parameter) {
     ...
     * @return query实例
     */
    public Query whereEqual(final String propertyName, final Object value) {
     ...
     * @return query实例
     */
    public Query whereNotEqual(final String propertyName, final ParameterExpression parameter) {
     ...
     * @return query实例
     */
    public Query whereNotEqual(final String propertyName, final Object value) {
     ...
     * @param parameter    参数表达式
     */
    public Query whereLessThanOrEqual(final String propertyName, final ParameterExpression parameter) {
     ...
     * @param value        属性值
     */
    public Query whereLessThanOrEqual(final String propertyName, final Object value) {
     ...
     * @param parameter    参数表达式
     */
    public Query whereLessThan(final String propertyName, final ParameterExpression parameter) {
     ...
     * @param value        属性值
     */
    public Query whereLessThan(final String propertyName, final Object value) {
     ...
     * @param parameter    参数表达式
     */
    public Query whereGreaterThanOrEqual(final String propertyName, final ParameterExpression parameter) {
     ...
     * @param value        属性值
     */
    public Query whereGreaterThanOrEqual(final String propertyName, final Object value) {
     ...
     * @param parameter    参数表达式
     */
    public Query whereGreaterThan(final String propertyName, final ParameterExpression parameter) {
     ...
     * @param value        属性值
     */
    public Query whereGreaterThan(final String propertyName, final Object value) {
     ...
     * @return query实例
     */
    public Query whereOr(final List<String> propertyName, final ParameterExpression parameter) {
     ...
     * @return query实例
     */
    public Query whereOr(final List<String> propertyName, final Object value) {
     ...
     * @param parameter    参数表达式
     */
    public Query whereLike(final String propertyName, final ParameterExpression parameter) {
     ...
     * @param value        属性值
     */
    public Query whereLike(final String propertyName, final Object value) {
     ...
     * @return query实例
     */
    public Query whereOrLike(final List<String> propertyName, final ParameterExpression parameter) {
     ...
     * @return query实例
     */
    public Query whereOrLike(final List<String> propertyName, final Object value) {
     ...
     * @return query实例
     */
    public Query whereIsNull(final String propertyName) {
     ...
     * @return query实例
     */
    public Query whereIsNotNull(final String propertyName) {
     ...
     * @param go           属性结束值
     */
    public Query whereBetween(final String propertyName, final Date lo, final Date go) {
     ...
     * @param go           数字结束值
     */
    public Query whereBetween(final String propertyName, final ParameterExpression lo, final ParameterExpression go) {
        whereGreaterThanOrEqual(propertyName, lo).whereLessThanOrEqual(propertyName, go);
        return this;
    }
     ...
     * @param go           数字结束值
     */
    public Query whereBetween(final String propertyName, final Number lo, final Number go) {
        whereGreaterThanOrEqual(propertyName, lo).whereLessThanOrEqual(propertyName, go);
        return this;
    }
     ...
     * @param values       参数集合
     */
    public Query whereIn(final String propertyName, final List<ParameterExpression> values) {
     ...
     * @param values       参数值集合
     */
    public Query whereValueIn(final String propertyName, final List<Object> values) {
        In in = criteriaBuilder.in(from.get(propertyName));
        values.stream()
     ...
     * @param values       参数集合
     */
    public Query whereNotIn(final String propertyName, final List<ParameterExpression> values) {
        In in = criteriaBuilder.in(from.get(propertyName));
        values.stream().forEach(in::value);
     ...
     * @param values       参数集合
     */
    public Query whereValueNotIn(final String propertyName, final List<Object> values) {
        In in = criteriaBuilder.in(from.get(propertyName));
        values.stream()
                .map(this::makeParameter)
                .collect(Collectors.toList())
