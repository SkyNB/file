package com.tasfe.sis.base.dao.mybatis.plugins.page.support;

import com.tasfe.sis.base.dao.mybatis.plugins.page.MybatisPageImpl;
...
public class SqlUtil {
    ...
    public static PageHelper getPageFromObject(Object params) {
        ...
        Object icount = getParamValue(paramsObject, "count", false);
        boolean count = true;
        if (icount != null) {
            count = Boolean.valueOf(String.valueOf(icount));
        }
    ...
    public Object processPage(Invocation invocation) throws Throwable {
        try{
            Object result = myprocessPage(invocation);
            clearLocalPage();
...
//            	return resultPage ;
     ...
     * @throws Throwable 抛出异常
     */
    private Object myprocessPage(Invocation invocation) throws Throwable {
            ...
            if (parameterObject == null) {
                ...
                if (boundSql.getParameterMappings() != null && boundSql.getParameterMappings().size() > 0) {
                    for (ParameterMapping parameterMapping : boundSql.getParameterMappings()) {
                        ...
                        if (!PAGEPARAMETER_FIRST.equals(name)
                                && !PAGEPARAMETER_SECOND.equals(name)
