...
import com.tasfe.sis.auth.model.GetResourcesInfos;
...
public class ResourcesController {
    ...
    public ResponseData getResources(@RequestBody GetResourcesInfos getResourcesInfos) throws Exception {
        ResponseData responseData = new ResponseData();
        Long accountId = accountService.validateSessionCode(getResourcesInfos.getSessionCode());
        resourcesService.getResourcesWithAccountId(accountId);
