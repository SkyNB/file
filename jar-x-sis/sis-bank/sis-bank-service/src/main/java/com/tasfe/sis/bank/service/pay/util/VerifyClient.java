...
import com.tasfe.sis.bank.service.pay.util.itrus.ITrus;
...
public class VerifyClient {
    ...
    static {
        itrus.setCvmConfigFile(TransferPayConfig.cvm);
        itrus.setKeyPassword(TransferPayConfig.keypwd);
        itrus.setPfxFileName(TransferPayConfig.pfx);
        itrus.init();
    }
