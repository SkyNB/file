package com.tasfe.sis.bank.service.pay.util;
...
public final class Core {
    ...
    static{
    	...
    	try {
			sender.initCertWithKey(TransferPayConfig.pfx, TransferPayConfig.keypwd);
			recipient.initCertWithKey(TransferPayConfig.pfx, TransferPayConfig.keypwd);
			
			InputStream streamCert = new FileInputStream(TransferPayConfig.cvm);
